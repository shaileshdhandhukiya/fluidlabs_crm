...
const TeamshoursTable = ({ usersHoursData}) => {
  const columns = useMemo(() => COLUMNS, []);
  const data = useMemo(() => usersHoursData, [usersHoursData]);
...
export default TeamshoursTable;
